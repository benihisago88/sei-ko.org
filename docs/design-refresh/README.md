...
> **現在の位置付け（2026-08-15）**: Phase 0・1・2・3・5・6・7は完了し、
> Phase 4はユーザー判断で見送りです。これはデザイン刷新の計画・履歴です。
> 日常の更新・本番配信は、リポジトリ直下の[README](../../README.md)と
> [運用手順](../operations/deployment-and-recovery.md)を参照してください。
> 現在のデザイン作業の状態は[PROGRESS.md](PROGRESS.md)を正とします。
